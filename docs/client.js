...
import createMention from './lib/index.js';
window.addEventListener('load', () => {
    {
        const example = document.querySelector('#example');
        const dropdownElement = example.querySelector('[data-suggestions]');
        const contentEditableElement = example.querySelector('[contenteditable]');
        const prefixInput = example.querySelector('[name="prefix"]');
        let suggestionItems = [];
        ...
        const createMentionElement = (suggestion) => {
        ...
        const showDropdown = (_a) => __awaiter(void 0, [_a], void 0, function* ({ query, position }) {
            ...
            suggestionItems = (yield getSuggestions(query)) || [];
            dropdownElement.innerHTML = !(suggestionItems === null || suggestionItems === void 0 ? void 0 : suggestionItems.length)
        ...
        let mention;
        const mountMention = () => {
            mention === null || mention === void 0 ? void 0 : mention.off();
        ...
        contentEditableElement.addEventListener('keydown', (event) => {
            ...
            if (event.key === 'ArrowDown' || event.key === 'ArrowUp') {
                ...
                if (selectedSuggestion < 0)
                    selectedSuggestion = suggestionItems.length - 1;
                if (selectedSuggestion >= suggestionItems.length)
                    selectedSuggestion = 0;
            ...
            if (event.key === 'Enter') {
                ...
                mention === null || mention === void 0 ? void 0 : mention.set(createMentionElement(suggestionItem));
            }
            return;
        });
        dropdownElement.addEventListener('click', (e) => {
            var _a;
            e.preventDefault();
            const item = (_a = e.target) === null || _a === void 0 ? void 0 : _a.closest('li[data-index]');
            const suggestionItem = suggestionItems[parseInt(item.dataset.index, 10)];
            if (suggestionItem)
                mention === null || mention === void 0 ? void 0 : mention.set(createMentionElement(suggestionItem));
            mention === null || mention === void 0 ? void 0 : mention.stop();
        });
    }
});
const elements = [
